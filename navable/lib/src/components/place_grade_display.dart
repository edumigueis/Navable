...
class PlaceGradeDisplay extends StatefulWidget {
  ...
  const PlaceGradeDisplay({super.key, required this.value, required this.stroke});
        ...
        builder: (context, constraints) {
          ...
          return Stack(
            ...
            children: [
                        ...
                        Expanded(
                          ...
                          child: Container(
                            color: widget.value <= 0.66
                                ? Colors.red
                                : Colors
                                .grey, // Red or gray depending on the value
                          ),
                        ),
              ...
              Positioned(
                left: arrowPosition - widget.stroke, // Offset arrow to center it
                child: Icon(
                  Icons.circle,
                  size: widget.stroke,
                  color: Colors.black,
